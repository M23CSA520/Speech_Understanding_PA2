...
#Task A 2. Preprocess &  Extract MFCC Features
...
# Task A 4.a: Compute MFCC Statistics
...
# Task A. 3 Visualize MFCC Spectrograms
...
# Task B: Define Neural Network Classifier
...
# Task B 2: Train and Evaluate Model
